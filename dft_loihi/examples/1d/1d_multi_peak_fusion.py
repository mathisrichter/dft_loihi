...
gauss_input1.add_gaussian_spike_rate(0, -0.775, 0.1, 100)
gauss_input1.add_gaussian_spike_rate(11200, -0.775, 0.1, 400)
gauss_input1.create()

gauss_input2 = PiecewiseStaticInput("input 2", net, domain=field_domain, shape=field_shape)
gauss_input2.add_gaussian_spike_rate(0, 0.775, 0.1, 100)
gauss_input2.add_gaussian_spike_rate(11200, 0.775, 0.1, 400)
gauss_input2.create()
