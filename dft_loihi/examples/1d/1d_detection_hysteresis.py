...
gauss_input = GaussPiecewiseStaticInput("input", net, domain=field_domain, shape=field_shape)
gauss_input.add_spike_rate(0, -2.5, 1.5, 100)
gauss_input.add_spike_rate(800, -2.5, 1.5, 100)
gauss_input.add_spike_rate(11200, -2.5, 1.5, 100)
gauss_input.add_spike_rate(800, -2.5, 1.5, 100)
gauss_input.add_spike_rate(0, -2.5, 1.5, 100)
gauss_input.create()
